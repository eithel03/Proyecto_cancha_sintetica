        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div className="flex items-center gap-3 sm:gap-4 min-w-0">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-gold text-navy font-bold text-sm flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <div className="flex gap-3 w-full">
                {isCreator ? (
                  ...
                  <Button
                    onClick={onAccept}
                    disabled={pending}
                    className="w-full bg-green-900 hover:bg-green-900/90 text-white font-semibold h-11 rounded-xl transition-colors"
                  >
            ...
            {status === 'confirmed' && (
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full">
                <div className="bg-green-50 border border-green-200 text-green-700 font-semibold px-5 py-3 rounded-xl text-xs w-full sm:flex-1 text-center flex items-center justify-center gap-2">
                ...
                <span className="text-xs font-semibold text-green-700">¡Escenario listo!</span>
              </div>
            )}
          </div>
        </div>
